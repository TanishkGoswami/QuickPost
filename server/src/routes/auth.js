...
router.get('/google/callback', async (req, res) => {
  ...
  try {
    ...
    if (decodedState && decodedState.userId) {
      ...
      console.log('🔗 [AUTH] Connecting YouTube account for user:', decodedState.userId);
...
router.delete('/disconnect/:provider', authenticateUser, async (req, res) => {
  try {
    ...
    const validProviders = ['youtube', 'instagram', 'pinterest', 'facebook', 'bluesky', 'linkedin', 'mastodon', 'threads', 'x', 'reddit'];

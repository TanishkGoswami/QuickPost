    ...
    <section id="pricing" className="landing-section" style={{ padding: 'clamp(60px, 10vh, 100px) 24px', background: 'var(--canvas)' }}>
      <div className="landing-container" style={{ maxWidth: 1280, margin: '0 auto' }}>
        ...
        >
          ...
          <h2 style={{
            fontSize: 'clamp(28px, 4vw, 52px)', fontWeight: 600, color: 'var(--ink)',
            letterSpacing: '-0.03em', margin: '0 0 14px', lineHeight: 1.1,
          }}>
            Simple, honest pricing.
          </h2>
          <p style={{
            fontSize: 'clamp(15px, 2vw, 17px)', fontWeight: 450, color: 'var(--slate)',
            maxWidth: 460, margin: '0 auto 28px', lineHeight: 1.5,
          }}>
          ...
          {PLANS.map((plan, i) => (
            <motion.div
              ...
              style={{
                ...
                position: 'relative',
                boxShadow: plan.highlighted ? '0 32px 64px -16px rgba(20,20,19,0.2)' : 'none',
            ...
            >
              ...
              <div style={{ marginBottom: 16 }}>
                <div style={{ fontSize: 17, fontWeight: 600, color: plan.highlighted ? 'var(--canvas)' : 'var(--ink)', letterSpacing: '-0.02em', marginBottom: 5 }}>
                  {plan.name}
                </div>
                <div style={{ fontSize: 13, fontWeight: 450, color: plan.highlighted ? 'rgba(243,240,238,0.55)' : 'var(--slate)', lineHeight: 1.5 }}>
                  {plan.description}
                </div>
              </div>
              ...
              <div style={{ marginBottom: 20 }}>
                <div style={{ display: 'flex', alignItems: 'flex-end', gap: 4 }}>
                  <span style={{
                    fontSize: 'clamp(36px, 4vw, 48px)', fontWeight: 600, lineHeight: 1,
              ...
              <button
                ...
                style={{
                  ...
                  border: plan.highlighted ? 'none' : '1px solid rgba(20,20,19,0.12)',
              ...
              {/* Divider */}
              <div style={{ borderTop: `1px solid ${plan.highlighted ? 'rgba(243,240,238,0.1)' : 'rgba(20,20,19,0.07)'}`, marginBottom: 20 }} />
              ...
              <ul style={{ listStyle: 'none', padding: 0, margin: 0, display: 'flex', flexDirection: 'column', gap: 11 }}>
                {plan.features.map(f => (
                  <li key={f} style={{ display: 'flex', alignItems: 'flex-start', gap: 10 }}>
                    ...
                    <span style={{ fontSize: 13, fontWeight: 450, color: plan.highlighted ? 'rgba(243,240,238,0.7)' : 'var(--slate)', lineHeight: 1.5 }}>
                      {f}
                    </span>
                  </li>
                ))}
